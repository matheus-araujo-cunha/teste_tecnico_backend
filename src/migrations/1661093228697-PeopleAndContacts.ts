...
export class PeopleAndContacts1661093228697 implements MigrationInterface {
    name = 'PeopleAndContacts1661093228697'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "infoContacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "info" character varying NOT NULL, "peopleId" uuid, "contactId" uuid, CONSTRAINT "UQ_3e1491066c83464d1f20f2a3e5d" UNIQUE ("info"), CONSTRAINT "PK_9b6fd47e923f0e99acb204b99d5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "infoContacts" ADD CONSTRAINT "FK_0db474c2f1aa8ba776bb2134f58" FOREIGN KEY ("contactId") REFERENCES "contacts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "infoContacts" DROP CONSTRAINT "FK_0db474c2f1aa8ba776bb2134f58"`);
